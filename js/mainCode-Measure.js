...
// function addToMapDrawing(geometry) {
    ...
    // switch (geometry.type) {
        ...
        // case "polygon":
            ...
            // symbols.polygon = new es.SimpleFillSymbol("solid", new es.SimpleLineSymbol("solid", new dc([255, 155, 0]), 2), new dc([255, 155, 0, 0.25]));
...
// function labelGeom(geometryL) {
    ...
    // var x3 = x1 - 10;
    // var y3 = y1;
    // var labelPolygon = new esri.geometry.Polygon(new esri.SpatialReference({ wkid: 102100 }));
...
// require(["dojo/dom","esri/symbols/TextSymbol","esri/symbols/Font","esri/Color","esri/graphic"], function(dom,TextSymbol,Font,Color, Graphic) {
