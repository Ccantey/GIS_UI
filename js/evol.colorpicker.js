...
var _idx=0,
	...
	subThemeColors=['000000','8e0f00','a83026','9c981d','006100','001b82','471d84',
					'848484','e02937','eaa500','ffd300','22871b','003fff','8448e5',
					'ffffff','f4837e','ffba3f','ffe461','82f800','80cfec','a0a2ff'
	],
...
$.widget( "evol.colorpicker", {
		...
		switch(this.element.get(0).tagName){
			case 'INPUT':
				...
				e.addClass('colorPicker '+this._id)
					.wrap('<div style="width:'+(this.element.width()+21)+'px;'
	...
	_paletteHTML1: function() {
		var h=[], labels=this.options.strings.split(','),
			...
			oTRTH='<tr><th colspan="7" class="ui-widget-content">';
		// base theme colors
		//h.push('<table class="evo-palette',_ie,'">',oTRTH,labels[0],'</th></tr><tr>');
		h.push('<table class="evo-palette',_ie,'">');
		//for(var i=0;i<10;i++){ 
		...
		for(var r=1;r<3;r++){
			...
			for(var i=0;i<7;i++){ 
				h.push(oTD, subThemeColors[r*7+i], cTD);
			}			
		}
